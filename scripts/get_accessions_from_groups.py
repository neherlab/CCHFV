...
if __name__=="__main__":
    ...
    parser.add_argument('--metadata', type=str, required=True, help="name of metadata of segment to get accessions from")
    parser.add_argument('--groups', type=str, required=True, help="name of group_ids file for which accessions should be selected")
    parser.add_argument('--output', type=str, required=True, help="name of output text file with accession numbers")
